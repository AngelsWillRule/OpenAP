...
namespace OpenAP\Plugins;

use OpenAP\UI\Sidebar;
...
class PluginManager
{
    ...
    private function autoloadPlugins(): void
    {
        ...
        foreach ($directories as $dir) {
            ...
            if (file_exists($pluginFile)) {
                ...
                $pluginClass = $this->resolvePluginClass($pluginName);
                if ($pluginClass !== null) {
    ...
    public function getInstalledPlugins(): array
    {
        ...
        if (file_exists($this->pluginPath)) {
            ...
            foreach ($directories as $directory) {
                ...
                $pluginClass = file_exists($pluginFile) ? $this->resolvePluginClass($directory) : null;
                if ($pluginClass !== null) {
                    $plugins[] = $pluginClass;
                }
            }
    ...
    private function resolvePluginClass(string $pluginName): ?string
    {
        $pluginClass = "OpenAP\\Plugins\\$pluginName\\$pluginName";
