...
class DnsmasqManager
{
    ...
    {
        $configFile = OPENAP_DNSMASQ_PREFIX . "$iface.conf";
        $lines = [];
    ...
    public function buildDefault(array $post_data): array
    {
        ...
        $config[] = 'log-facility='. OPENAP_DHCPCD_LOG;
    ...
    {
        $configFile = OPENAP_DNSMASQ_PREFIX . $iface . SELF::CONF_SUFFIX;
    ...
    {
        system('sudo rm '.OPENAP_DNSMASQ_PREFIX.$iface.'.conf', $result);
        if ($result == 0) {
